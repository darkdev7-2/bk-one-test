                        ...
                        <form action="{{ route('user.withdraw.account.update', $withdrawAccount->id) }}" method="post"
                            ...
                            <div class="row selectMethodRow">
                                <div class="col-xl-6 col-md-12">
                                    <div class="inputs">
                                        <label for="" class="input-label">{{ __('Method Name:') }}<span
                                ...
                                @foreach (json_decode($withdrawAccount->credentials, true) as $key => $field)
                                    @if ($field['type'] == 'file')
                                        ...
                                        <div class="col-xl-6 col-md-12">
                                            ...
                                            <div class="wrap-custom-file">
                                                <input type="file" name="credentials[{{ $key }}][value]"
                                    ...
                                    @elseif($field['type'] == 'textarea')
                                        ...
                                        <div class="col-xl-6 col-md-12 inputs">
                                            ...
                                            <div class="input-group">
                                                <textarea class="form-control-textarea" @if ($field['validation'] == 'required') required @endif placeholder="Send Money Note"

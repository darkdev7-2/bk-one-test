                        ...
                        <form action="{{ route('user.pay.bill.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6" id="labels">
                                    <div class="inputs">
                                        <label for="" class="input-label">{{ __('Mobile Number') }} <span class="required">*</span></label>
                                        <div class="input-group">
                                            <input type="text" name="data['Moblie Number']" class="form-control" placeholder="{{ __('Mobile Number') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6">

                        ...
                        @foreach ($plans as $plan)
                            <div class="col-xl-4 col-lg-6 col-md-6 col-12">
                                <div class="plan-card-box">
                                    ...
                                    <div class="amount">{{ $plan->per_installment }}%<span>/
                                            {{ $plan->installment_intervel }} {{ __('Days') }}</span></div>
                                    <div class="list">
                                        <div class="single">
                                        ...
                                        <div class="single">
                                            ...
                                            <div>{{ $plan->loan_fee . ' ' . $currency }}</div>
                                        </div>
                                    </div>
                                    <a href="" class="site-btn-sm black-btn subscribeBtn" type="button"
                                        data-name="{{ $plan->name }}" data-id="{{ encrypt($plan->id) }}"
                                        data-min="{{ $plan->minimum_amount }}" data-max="{{ $plan->maximum_amount }}"
                                        data-bs-toggle="modal" data-bs-target="#fdr">

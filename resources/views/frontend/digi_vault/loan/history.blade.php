            ...
            <div class="site-card">
                <div class="site-card-header">
                    ...
                    <div class="card-header-links">
                        <a href="{{ route('user.loan.index') }}" class="card-header-link"><i
                                data-lucide="archive"></i>{{ __('Loan Plan List') }}</a>
                    </div>
                </div>
                        ...
                        <div class="table-filter">
                            <div class="filter">
                                <div class="single-f-box">
                                    ...
                                    <input class="search" type="text" name="loan_id" value="{{ request('loan_id') }}"
                                        autocomplete="off" />
                                </div>
                                <div class="single-f-box">
                                ...
                                <div class="site-table-list">
                                    ...
                                    <div class="site-table-col">
                                        <div class="description">
                                            <div class="content">
                                                <div class="title">
                                                    {{ ($loan->amount / 100) * $loan->plan->per_installment }}
                                                    {{ $currency }}</div>
                                                <div class="date">Every {{ $loan->plan->installment_intervel }} Days
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="site-table-col">
                                        <div class="fw-bold">{{ $loan->transactions->sum('amount') }} {{ $currency }}
                                        </div>
                                    </div>
                                    <div class="site-table-col">
                                    ...
                                    <div class="site-table-col">
                                        <div class="action">
                                            <a href="{{ route('user.loan.details', $loan->loan_no) }}"

        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
            <div class="site-card">
                ...
                <div class="site-card-body p-0 overflow-x-auto">
                        ...
                        <div class="contents">
                            ...
                            @foreach ($cards as $card)
                                <div class="site-table-list">
                                    ...
                                    <div class="site-table-col">
                                        <div class="trx fw-bold">
                                            {{ Carbon\Carbon::parse($card->created_at)->format('M d, Y') }}</div>
                                    </div>
                                    <div class="site-table-col">
                                        <div class="action">
                    ...
                    <div class="modal fade" id="createWalletModal" aria-labelledby="openTicketModalLabel"
                        aria-hidden="true">
                                            ...
                                            <div class="step-details-form">
                                                <div class="row">
                                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                                        <div class="inputs">
                                                            <label for=""
                                                                class="input-label">{{ __('Choose Card Provider') }}<span
                                                                    class="required">*</span></label>
                                                            <select class="add-priority box-input page-count"
                                                                id="card_provider_name" name="card_provider_name">
                                                                <option selected disabled value="">
                                                                    {{ __('Select Card Provider') }}</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-12 col-md-12 inputs">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input onclick="changeCardholderType('existing_one')"
                                                                    class="form-check-input" type="radio" name="type"
                                                                    id="existing_one" value="existing_one" checked>
                                                                <label class="form-check-label" for="existing_one">
                                                                    {{ __('Existing Cardholders') }}
                                                                </label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input onclick="changeCardholderType('new_one')"
                                                                    class="form-check-input" type="radio" name="type"
                                                                    id="new_one" value="new_one">
                                                ...
                                                <div class="step-details-form" id="existing_cardholder_part">
                                                    <div class="row">
                                                        <div class="col-xl-12 col-lg-12 col-md-12">
                                                            <div class="inputs">
                                                                <label for=""
                                                                    class="input-label">{{ __('Choose Cardholder') }}<span
                                                                        class="required">*</span></label>
                                                                <select class="add-priority box-input page-count"
                                                                    name="cardholder_id">
                                                                    <option selected disabled value="">
                                                                        {{ __('Select Cardholder') }}</option>
                                                ...
                                                <div class="step-details-form" id="new_cardholder_part">
                                                    <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl-4 col-md-4 inputs">
                                                                <label class="form-label">{{ __('Postal Code') }} <span
                                                                        class="required">*</span></label>
                                                                <div class="input-group">
                                                        ...
                                                        <div class="col-xl-12 col-lg-12 col-md-12">
                                                            <div class="inputs">
                                                                <label for=""
                                                                    class="input-label">{{ __('Country') }}<span
                                                                        class="required">*</span></label>
...
@push('js')
    <script>
        $('#existing_one').is(':checked') ? $('#new_cardholder_part').addClass('d-none') : $('#existing_cardholder_part')
            .addClass('d-none');

        ...
        <div class="container">
            <div class="auth-from-main">
                ...
                <div class="auth-from-box">
                    <form id="SignInForm" action="{{ route('password.update') }}" method="POST" >
                        @csrf
                        ...
                        <div class="row gy-24 mb-4">
                            <div class="col-xxl-12">
                                <div class="td-form-group">
                                    ...
                                    <div class="input-field">
                                        <input type="email" name="email" class="form-control" required value="{{ old('email',$request->email) }}" readonly>
                                    </div>
                            ...
                            <div class="col-xxl-12">
                                <div class="td-form-group has-right-icon">
                                    ...
                                    <div class="input-field">
                                        <input type="password" name="password_confirmation" class="form-control password-input" required>
                                        <span class="input-icon eyeicon"><i class="icon-eye-slash"></i></span>
                                    </div>
                                    <p class="feedback-invalid">{{ __('This field is required') }}</p>
                                </div>

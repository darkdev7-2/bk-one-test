                ...
                <div class="site-card-body">
                    <div class="step-details-form mb-4">
                        <div class="row">
                            ...
                            <div @class([ 'col-xl-4 col-lg-4 col-md-4'=> setting('multiple_currency','permission'),
                                ...
                                <div class="inputs">
                                    ...
                                    <select name="gateway_code" class="box-input deposit-methods" id="gatewaySelect">
                                        ...
                                        <option data-logo="{{ asset('front/images/payment_gateway.svg') }}" value="" disabled selected>--{{ __('Select Gateway') }}--</option>
                                        @if(!setting('multiple_currency','permission'))
                        ...
                        <div class="site-card-body p-0 overflow-x-auto">
                            <div class="site-custom-table site-custom-table-sm">
                                <div class="contents">
                                    ...
                                    <div class="site-table-list conversion">
                                        <div class="site-table-col">
...
<script>
    ...
    function formatState(state) {
        ...
        var $state = $(
            '<span>' +
            ($(state.element).data('logo') ? '<img src="' + $(state.element).data('logo') + '" class="img-icon"/> ' : '') +
            state.text +
            '</span>'
        );
        return $state;

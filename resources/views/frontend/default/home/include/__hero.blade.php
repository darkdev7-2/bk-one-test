                ...
                <div class="banner-thumb-wrapper" data-aos="fade-left" data-aos-duration="2000">
                    <div class="banner-thumb">
                        @if (content_exists($data['hero_right_img']))
                            <img src="{{ asset($data['hero_right_img']) }}" alt="thumb not found">
                        @endif
                    </div>
                    <div class="user-one">
                    ...
                    <div class="shape-text">
                        <span>
                            <svg width="48" height="48" viewBox="0 0 48 48" fill="none"
                                ...
                                <path d="M21 24L23 26L27 22" stroke="black" stroke-width="2" stroke-linecap="round"

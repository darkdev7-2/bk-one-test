...
@section('content')
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                    ...
                    <div class="referral-card">
                        <div class="row">
                            <div class="col-xl-7 col-lg-8 col-md-12">
                                <div class="title">
                                    {{ __('Earn :amount after inviting one members', ['amount' => $currencySymbol . setting('referral_bonus', 'fee')]) }}
                                </div>
                                <div class="referral-form-box">
                                    <form action="#">
                                        <input class="referral-code-input" id="refLink" type="text"
                                            value="{{ $getReferral->link }}" required />
                                        <button type="button" onclick="copyRef()" id="copyBtn">
                                            <i data-lucide="copy"></i><span>{{ __('Copy') }}</span>
                                        </button>
                                    </form>
                                    <div class="info">
                                        {{ __(':people_count peoples are joined by using this URL', ['people_count' => $getReferral->relationships()->count()]) }}
                                    </div>
                                    <a href="" class="site-btn polis-btn mt-4" data-bs-toggle="modal"
                                        data-bs-target="#shareButtons">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-12">
                                <img class="referral-icon" src="{{ asset('front/images/referral-icon.png') }}"
                                    alt="" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal fade" id="shareButtons" tabindex="-1" aria-labelledby="shareButtonsModalLabel"
                aria-hidden="true">
                    ...
                    <div class="modal-content site-table-modal">
                        <div class="modal-body popup-body">
                            ...
                            <div class="popup-body-text">
                                ...
                                <a href="http://www.facebook.com/sharer.php?u={{ $getReferral->link }}" target="_blank"
                                    class="site-btn primary-btn w-100 mb-3 centered">
                                    <i data-lucide="facebook"></i>{{ __('Facebook') }}
                                </a>
                                <a href="http://twitter.com/share?url={{ $getReferral->link }}" target="_blank"
                                    class="site-btn primary-btn w-100 mb-3 centered">
                                    <i data-lucide="twitter"></i>{{ __('Twitter') }}
                                </a>
                                <a href="http://www.linkedin.com/shareArticle?mini=true&url={{ $getReferral->link }}"
                                    target="_blank" class="site-btn primary-btn w-100 mb-3 centered">
                                ...
                                <div class="site-table-list">
                                    ...
                                    <div class="site-table-col">
                                        <div class="type site-badge badge-pending">
                                            {{ $user->portfolio?->portfolio_name ?? __('N/A') }}
                                        </div>
                                    </div>
                                    <div class="site-table-col">
                                        @if ($user->status == 1)

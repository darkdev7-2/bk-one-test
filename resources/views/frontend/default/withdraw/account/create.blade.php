            ...
            <div class="site-card">
                <div class="site-card-header">
                    ...
                    <div class="card-header-links">
                        <a href="{{ route('user.withdraw.account.index') }}" class="card-header-link"><i
                                data-lucide="alert-circle"></i>{{ __('Withdraw Account') }}</a>
                    </div>
                </div>
                        ...
                        <div class="step-details-form mb-4">
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 selectMethodCol">
                                    <div class="inputs">
                                        <label for="" class="input-label">{{ __('Select') }}<span
                                                class="required">*</span></label>
                                        <select name="withdraw_method_id" class="box-input select2-basic-active"
                                            id="selectMethod">
    ...
    <script>
        ...
        $("#selectMethod").on('change', function(e) {
            ...
            $.get(url, function(data) {
                var content = $(data).addClass('dynamic-fields');
                content.insertAfter(".selectMethodCol");
                imagePreview();
            });
        });
    </script>

                        ...
                        <div class="table-filter">
                            <div class="filter">
                                <div class="single-f-box">
                                    ...
                                    <input class="search" type="text" name="fdr_id" value="{{ request('fdr_id') }}"
                                        autocomplete="off" />
                                </div>
                                <div class="single-f-box">
                                    ...
                                    <div class="site-table-col">
                                        <div class="description">
                                            <div class="content">
                                                ...
                                                <div class="date">{{ __('Every') }} {{ $fdr->plan?->intervel }}
                                                    {{ __('Days') }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="site-table-col">
                                        <div class="description">
                                            <div class="content">
                                                ...
                                                <div class="date">{{ __('Return') }}:
                                                    {{ $fdr->givenInstallemnt() ?? 0 }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="site-table-col">
                                        <div class="fw-bold">{{ $fdr->transactions->sum('paid_amount') }}
                                            {{ $currency }}</div>
                                    </div>
                                    <div class="site-table-col">
                                    ...
                                    <div class="site-table-col">
                                        <div class="action">
                                            ...
                                            @php
                                                ...
                                                $currentDate = now();
                                                $cancel_fee =
                                                    $fdr->plan?->cancel_fee_type == 'percentage'
                                                        ? ($fdr->plan?->cancel_fee / 100) * $fdr->amount
                                                        : $fdr->plan?->cancel_fee;
                                            @endphp
                                                ...
                                                @if ($fdr->plan?->cancel_type == 'fixed' && $currentDate->diffInDays($creationDate) <= $cancellationDays)
                                                    <span data-bs-toggle="modal" data-bs-target="#cancelFDR">
                                                        <button class="circle-btn red-btn cancelBtn"
                                                            ...
                                                            data-bs-placement="top" data-bs-title="{{ __('Cancel FDR') }}">
                                                            <i data-lucide="x"></i>
                                                        </button>
                                                    </span>

                        ...
                        <form method="POST" action="{{ route('user.setting.2fa.verify') }}">
                                ...
                                <div class="col-xxl-12">
                                    ...
                                    <div class="single-floating-input">
                                        ...
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="email" placeholder="" name="one_time_password" required autofocus>
                                            <label for="floatingPassword">{{ __('One Time Password') }} <span>*</span></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="auth-bottom-content">
                                <div class="auth-from-btn-wrap">
                                    <button class="site-btn gdt-btn w-100" type="submit">{{ __('Authenticate Now') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>

                    ...
                    <div class="step-details-form">
                        <form action="{{ route('user.pay.bill.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6">
                                    <div class="inputs">
                                        <label for="" class="input-label"><span class="label-name">{{ __('Account Number') }}</span> <span class="required">*</span></label>
                                        <div class="input-group">
                                            <input type="text" name="data['Account Number']" class="form-control" id="label-input" placeholder="{{ __('Account Number') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6">

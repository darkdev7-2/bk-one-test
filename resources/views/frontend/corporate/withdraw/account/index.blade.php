            ...
            <div class="site-card">
                <div class="site-card-header">
                    ...
                    <div class="card-header-links">
                        <div class="d-flex">
                            <a href="{{ route('user.withdraw.view') }}" class="card-header-link"><i
                                    data-lucide="download"></i>{{ __('Withdraw Money') }}</a>
                        ...
                        <div class="contents">
                            ...
                            @foreach ($accounts as $account)
                                <div class="site-table-list">
                                    <div class="site-table-col">
                                        <div class="description">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="date">{{ $account->method->currency . ' ' . __('Account') }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="site-table-col">
                                        <div class="action">
                                            <a href="{{ route('user.withdraw.account.edit', $account->id) }}"
                                                class="icon-btn me-2">
                                                <i data-lucide="edit-2"></i> {{ __('Edit') }}
                                            </a>
                                            <a href="javascript:void(0)" class="icon-btn bg-danger delete-btn"
                                        ...
                                        <form action="" method="post" id="delete-account">
                                            ...
                                            <div class="action-btns">
                                                <button type="submit" class="site-btn-sm primary-btn me-2"> <i
                                                        data-lucide="check"></i> {{ __('Confirm') }} </button>

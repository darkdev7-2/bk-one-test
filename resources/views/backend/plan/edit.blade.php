...
@section('content')
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <form action="{{ route('admin.plan.fdr.update', $plan->id) }}" method="post"
                                ...
                                <div class="row">
                                        ...
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="number" name="minimum_amount" class="form-control"
                                                    value="{{ $plan->minimum_amount }}" required />
                                                <span
                                        ...
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="number" name="maximum_amount" class="form-control"
                                                    value="{{ $plan->maximum_amount }}" required />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="number" name="interest_rate" class="form-control" step="0.01"
                                                    value="{{ $plan->interest_rate }}" required />
                                    ...
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="number" name="intervel" class="form-control"
                                                    value="{{ $plan->intervel }}" required />
                                        ...
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="text" name="maturity_platform_fee"
                                                    ...
                                                    value="{{ $plan->maturity_platform_fee }}" class="form-control" />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="site-input-groups">
                                            ...
                                            <div class="switch-field same-type">
                                                ...
                                                <input type="radio" id="radio-can-cancel1" name="can_cancel"
                                                    value="0" @checked(!$plan->can_cancel) />
                                    ...
                                    <div class="col-xl-6" id="cancel_fee_sec">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="position-relative">
                                                <input type="number" class="box-input" placeholder="charge"
                                                    name="cancel_fee" oninput="this.value = validateDouble(this.value)"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6" id="fdr-max-increase">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="text" name="increment_times"
                                        ...
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="text" name="min_increment"
                                                    oninput="this.value = validateDouble(this.value)"
                                                    value="{{ $plan->min_increment_amount }}" class="form-control" />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="site-input-groups">
                                            ...
                                            <div class="switch-field same-type">
                                                ...
                                                <input type="radio" id="decrement-fixed" name="decrement_type"
                                                    @checked($plan->decrement_type == 'fixed') value="fixed" />
                                    ...
                                    <div class="col-xl-6" id="fdr-max-decrease">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="text" name="decrement_times"
                                        ...
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="text" name="min_decrement"
                                                    value="{{ $plan->min_decrement_amount }}"
                                                    oninput="this.value = validateDouble(this.value)"
                                                    class="form-control" />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="switch-field same-type">
                                            ...
                                            <input type="radio" id="radio-six" name="status"
                                                @checked(!$plan->status) value="0" />
        ...
        (function($) {
            ...
            function toggleIsFundAddVisibility() {
                ...
                if (type == 1) {
                    ...
                    var incrementType = $('input[name="increment_type"]:checked').val();
            ...
            function toggleIsFundDeductVisibility() {
                ...
                if (type == 1) {
                    ...
                    var decreaseType = $('input[name="decrement_type"]:checked').val();

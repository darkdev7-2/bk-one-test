...
@section('content')
    <div class="main-content">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        <div class="title-content">
                            <h2 class="title">{{ __('Edit DPS Plan') }}</h2>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <form action="{{ route('admin.plan.dps.update', $plan->id) }}" method="post"
                            ...
                            <div class="site-card-body">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            <label class="box-input-label"
                                                for="">{{ __('Installment Interval:') }}</label>
                                    ...
                                    <div class="col-xl-6 schema-name">
                                        <div class="site-input-groups">
                                            <label class="box-input-label"
                                                for="">{{ __('Total Installment:') }}</label>
                                            <input type="number" id="total_installment" name="total_installment"
                                                value="{{ $plan->total_installment }}" class="box-input" required />
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            <label class="box-input-label"
                                                for="">{{ __('Per Installment:') }}</label>
                                            <div class="input-group joint-input">
                                                <input type="number" id="per_installment" name="per_installment"
                                                    class="form-control" value="{{ $plan->per_installment }}" />
                                                <span
                                    ...
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            <label class="box-input-label"
                                                for="">{{ __('Interest Rate:') }}</label>
                                            <div class="input-group joint-input">
                                                <input type="number" id="interest_rate" name="interest_rate" step="0.01"
                                                    class="form-control" value="{{ $plan->interest_rate }}" />
                                    ...
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            <label class="box-input-label"
                                                for="">{{ __('Total Deposit:') }}</label>
                                            <div class="input-group joint-input">
                                                <input type="text" id="total_deposit" name="total_deposit"
                                                    class="form-control" value="{{ $plan->total_deposit }}" readonly />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            <label class="box-input-label"
                                                for="">{{ __('Profit Amount:') }}</label>
                                            <div class="input-group joint-input">
                                                <input type="text" id="user_profit" name="user_profit"
                                                    class="form-control" value="{{ $plan->user_profit }}" readonly />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            <label class="box-input-label"
                                                for="">{{ __('Total Mature Amount:') }}</label>
                                            <div class="input-group joint-input">
                                                <input type="text" id="total_mature_amount" name="total_mature_amount"
                                                    class="form-control" value="{{ $plan->total_mature_amount }}"
                                                    readonly />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                            </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            <label class="box-input-label"
                                                for="">{{ __('Charge will Apply if Delay:') }}</label>
                                            <div class="input-group joint-input">
                                                <input type="number" name="delay_days" class="form-control"
                                                    value="{{ $plan->delay_days }}" />
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <div class="prcntcurr">
                                                    <select name="charge_type" class="form-select" id="">
                                                        <option value="percentage" @selected($plan->charge_type == 'percentage')>
                                                            {{ __('%') }}</option>
                                                        <option value="fixed" @selected($plan->charge_type == 'fixed')>
                                    ...
                                    <div class="col-xl-6" id="maturity-platform-fee-sec">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="text" name="maturity_platform_fee"
                                                    oninput="this.value = validateDouble(this.value)" class="form-control"
                                                    value="{{ $plan->maturity_platform_fee }}" />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6" id="cancel_time_sec">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="text" name="cancel_days" class="form-control"
                                                    value="{{ $plan->cancel_days }}" />
                                                <span class="input-group-text">{{ __('Days') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="site-input-groups">
                                            ...
                                            <div class="position-relative">
                                                <input type="number" class="box-input" name="cancel_fee"
                                                    oninput="this.value = validateDouble(this.value)"
                                                    value="{{ $plan->cancel_fee }}" />
                                                <div class="prcntcurr">
                                                    <select name="cancel_fee_type" class="form-select" id="">
                                                        <option value="percentage" @selected($plan->cancel_fee_type == 'percentage')>
                                                            {{ __('%') }}</option>
                                                        <option value="fixed" @selected($plan->cancel_fee_type == 'fixed')>
                                                            {{ $currencySymbol }}</option>
                                                    </select>
                                                </div>
                                            </div>
                            ...
                            <div class="site-card-body">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6" id="increase_time">
                                        <div class="site-input-groups">
                                            <label class="box-input-label"
                                                for="">{{ __('Max Increase Limit:') }}</label>
                                            <div class="input-group joint-input">
                                                <input type="number" name="increment_times" class="form-control"
                                                    value="{{ $plan->increment_times }}" />
                                    ...
                                    <div class="col-xl-6" id="dps-min-increase-amount">
                                        <div class="site-input-groups">
                                            <label class="box-input-label"
                                                for="">{{ __('Min Increase Amount:') }}</label>
                                            <div class="input-group joint-input">
                                                <input type="text" name="min_increment"
                                                    value="{{ $plan->min_increment_amount }}"
                                                    oninput="this.value = validateDouble(this.value)"
                                                    class="form-control" />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                    ...
                                    <div class="col-xl-6" id="dps-max-increase-amount">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="text" name="max_increment"
                                                    value="{{ $plan->max_increment_amount }}"
                                                    oninput="this.value = validateDouble(this.value)"
                                                    class="form-control" />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                        ...
                                        <div class="site-input-groups">
                                            ...
                                            <div class="switch-field same-type">
                                                <input type="radio" id="increment-charge-yes"
                                                    name="increment_charge_type" @checked($plan->increment_charge_type)
                                                    value="1" />
                                        ...
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="text" name="increment_fee"
                                                    oninput="this.value = validateDouble(this.value)"
                                                    value="{{ $plan->increment_fee }}" class="form-control" />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                            </div>
                                        </div>
                            ...
                            <div class="site-card-body">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6" id="decrease_time">
                                        <div class="site-input-groups">
                                            <label class="box-input-label"
                                                for="">{{ __('Max Decrease Limit:') }}</label>
                                            <div class="input-group joint-input">
                                                <input type="number" name="decrement_times" class="form-control"
                                                    value="{{ $plan->decrement_times }}" />
                                                <span class="input-group-text">{{ __('Times') }}</span>
                                        ...
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="text" name="min_decrement"
                                                    oninput="this.value = validateDouble(this.value)"
                                                    value="{{ $plan->min_decrement_amount }}" class="form-control" />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-6" id="dps-max-decrease-amount">
                                        <div class="site-input-groups">
                                            <label class="box-input-label"
                                                for="">{{ __('Max Decrease Amount:') }}</label>
                                            <div class="input-group joint-input">
                                                <input type="text" name="max_decrement"
                                                    value="{{ $plan->max_decrement_amount }}"
                                                    oninput="this.value = validateDouble(this.value)"
                                                    class="form-control" />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                    ...
                                    <div class="col-xl-6" id="dps-decrease-charge-type">
                                        <div class="site-input-groups">
                                            <label class="box-input-label"
                                                for="">{{ __('Decrease Charge Type') }}</label>
                                            <div class="switch-field same-type">
                                                <input type="radio" id="decrement-charge-yes"
                                                    name="decrement_charge_type" @checked($plan->decrement_charge_type)
                                                    value="1" />
                                        ...
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="text" name="decrement_fee"
                                                    oninput="this.value = validateDouble(this.value)"
                                                    value="{{ $plan->decrement_fee }}" class="form-control" />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                            </div>
                                        </div>

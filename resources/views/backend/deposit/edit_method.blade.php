                                ...
                                <div class="site-input-groups row">
                                    <div class="col-xl-12">
                                        ...
                                        <div class="input-group joint-input">
                                            ...
                                            <span class="input-group-text currency-selected">{{  is_custom_rate($method->gateway?->gateway_code) ?? $method->currency }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6">
                                <div class="site-input-groups">
                                    ...
                                    <div class="input-group joint-input">
                                        ...
                                        <span class="input-group-text currency-selected">{{ $method->currency }}</span>
                                    </div>

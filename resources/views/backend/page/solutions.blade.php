...
@section('content')
    <div class="main-content">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="title-content">
                            <h2 class="title">{{ __('Solutions Page') }}</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="site-card">
                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.page.update') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="page_code" value="solutions">
                                ...
                                <div class="site-input-groups row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="page_title" class="box-input" value="{{ $data->page_title }}">
                                    </div>
                                </div>
                                ...
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Sub Title') }}<i data-lucide="info"
                                                                                                 data-bs-toggle="tooltip"
                                                                                                 title=""
                                                                                                 data-bs-original-title="Page Title will show on Breadcrumb"></i></label>
                                    <div class="col-sm-9">
                                        <input type="text" name="sub_title" class="box-input" value="{{ $data->sub_title }}">
                                    </div>
                                </div>
                                    ...
                                    <div class="site-input-groups row">
                                        ...
                                        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
                                            <div class="wrap-custom-file">
                                                <input type="file" name="shape_one_img" id="shpaeOne"
                                                       accept=".gif, .jpg, .png"/>
                                                <label for="shpaeOne" class="file-ok"
                                                       style="background-image: url( {{ asset( $data->shape_one_img ) }} )">
                                                    <img class="upload-icon"
                                                         src="{{ asset('global/materials/upload.svg') }}" alt=""/>
                                                    <span>{{ __('Update Image') }}</span>
                                                </label>
                                                @removeimg($data->shape_one_img,shape_one_img)
                                            </div>
                                        </div>
                                    </div>
                                    <div class="site-input-groups row">
                                        ...
                                        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
                                            <div class="wrap-custom-file">
                                                <input type="file" name="shape_two_img" id="shpaeTwo"
                                                       accept=".gif, .jpg, .png"/>
                                                <label for="shpaeTwo" class="file-ok"
                                                       style="background-image: url( {{ asset( $data->shape_two_img ) }} )">
                                                    <img class="upload-icon"
                                                         src="{{ asset('global/materials/upload.svg') }}" alt=""/>
                                                    <span>{{ __('Update Image') }}</span>
                                                </label>
                                                @removeimg($data->shape_two_img,shape_two_img)
                                            </div>
                                        </div>
                                    </div>
                                @endif
            ...
            @include('backend.page.include.__add_new_solution')

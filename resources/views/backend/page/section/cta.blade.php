                    ...
                    <div class="site-card">
                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                ...
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Button') }}
                                        <i data-lucide="info" data-bs-toggle="tooltip"
                                            data-bs-original-title="Leave it blank if you don't need this button"></i>
                                    </label>
                                    <div class="col-sm-9">
                                        <div class="form-row">
                                            @if ($key == 'en')
                                                    ...
                                                    <div class="site-input-groups">
                                                        ...
                                                        <div class="site-input-groups">
                                                            <select name="button_target" class="form-select">
                                                                ...
                                                                <option @if ($data->button_target == '_blank') selected @endif
                                ...
                                @if ($key == 'en' && site_theme() == 'corporate')
                                    <div class="site-input-groups row">
                                        ...
                                        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
                                            <div class="wrap-custom-file">
                                                <input type="file" name="right_img" id="heroRightImg"
                                                    accept=".gif, .jpg, .png" />
                                                <label for="heroRightImg" id="right_img"
                                                    @if ($data->right_img) class="file-ok"  style="background-image: url({{ asset($data->right_img) }})" @endif>

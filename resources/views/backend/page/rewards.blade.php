                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="title-content">
                            <h2 class="title">{{ __('Rewards Page') }}</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="site-card">
                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.page.update') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="page_code" value="rewards">
                                ...
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Title One') }}</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="title_one" class="box-input" value="{{ $data->title_one }}">
                                    </div>
                                </div>
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Title Two') }}</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="title_two" class="box-input" value="{{ $data->title_two }}">
                                    </div>
                                </div>
                                <div class="row mb-4">

                        ...
                        <div class="site-card">
                            <div class="site-card-body">
                                <p class="paragraph"><i data-lucide="alert-triangle"></i>{{ __('All the') }}
                                    <strong>{{ __('Menu Items are Draggable.') }}</strong>
                                    {{ __('Once you drag then click') }}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="round-icon-btn primary-btn editNavMenu"
                                                                ...
                                                                data-translations='@json($navigationTranslations[$navigation->id] ?? [])'
                                                                data-bs-toggle="modal" data-bs-target="#editNav"
                                                                type="button">
        ...
        $(document).on('click', '.editNavMenu', function(e) {
            ...
            if (translations) {
                Object.keys(translations).forEach(function(locale) {
                    $("input[name='translation[" + locale + "]']").val(translations[locale]);
                });
            }
            // fallback for name (en)
            $("input[name='translation[en]']").val(name);

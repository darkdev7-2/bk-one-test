<a href="{{ route('admin.language-keyword', $locale) }}" class="round-icon-btn blue-btn" data-bs-toggle="tooltip"
    title="" data-bs-original-title="{{ __('Web Translations') }}"><i data-lucide="languages"></i></a>

<a href="{{ route('admin.language.app-keyword', $locale) }}" class="round-icon-btn green-btn" data-bs-toggle="tooltip"
    title="" data-bs-original-title="{{ __('App Translations') }}"><i data-lucide="book-check"></i></a>

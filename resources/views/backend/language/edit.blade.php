                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.language.update',$language->id) }}" method="post">
                                ...
                                <div class="site-input-groups row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="box-input" required name="name" @if($language->locale == 'en') readonly @endif
                                               value="{{ $language->name }}"/>
                                    </div>
                                </div>
                                <div class="site-input-groups row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="box-input" name="code" value="{{ $language->locale }}" @if($language->locale == 'en') readonly @endif

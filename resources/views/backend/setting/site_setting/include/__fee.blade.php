<div class="col-xl-6 col-lg-12 col-md-12 col-12">
    <div class="site-card">
        ...
        <div class="site-card-body">
            ...
            <div class="site-input-groups row mb-0">
                <div class="col-sm-4 col-label">{{ __('Fund Transfer Limit (Own Bank)') }}</div>
                <div class="col-sm-8">
                    <div class="form-row">
                        <div class="col-xl-6 col-sm-12 col-12">
                            <div class="site-input-groups">
                                <label for="" class="box-input-label">{{ __('Min Fund Transfer:') }}</label>
                                <div class="input-group joint-input">
                                    <input type="text" class="form-control" name="min_fund_transfer"
                                           value="{{ oldSetting('min_fund_transfer','fee') }}">
                                    <span class="input-group-text">{{ setting('site_currency','global') }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-sm-12 col-12">
                            <div class="site-input-groups">
                                <label for="" class="box-input-label">{{ __('Max Fund Transfer:') }}</label>
                                <div class="input-group joint-input">
                                    <input type="text" class="form-control" name="max_fund_transfer"
                                           value="{{ oldSetting('max_fund_transfer','fee') }}">
                                    <span class="input-group-text">{{ setting('site_currency','global') }}</span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="site-input-groups row">
                <label for="" class="col-sm-4 col-label">{{ __('Fund Transfer Charge (Own Bank)') }}</label>
                <div class="col-sm-8">

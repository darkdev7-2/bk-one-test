...
@section('setting-title')
    {{ __('Plugin Settings' . ($title ? " - {$title}" : '')) }}
@endsection
@section('title')
    {{ __('Plugin Settings' . ($title ? " - {$title}" : '')) }}
@endsection
@section('setting-content')
    ...
    <div class="modal fade" id="editPlugin" tabindex="-1" aria-labelledby="editPluginModalLabel" aria-hidden="true">

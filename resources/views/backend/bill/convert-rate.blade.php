                            ...
                            <form action="" method="get">
                                <div class="row">
                                            ...
                                            <select name="method" class="form-select">
                                                ...
                                                @foreach ($methods as $method)
                                                    <option value="{{ strtolower($method->name) }}"
                                                        @selected(request('method') == strtolower($method->name))>{{ __($method->name) }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-xl-3">
                                        ...
                                        <button type="submit" name="type" value="get_currencies"
                        ...
                        <div class="site-card">
                            ...
                            <div class="site-card-body">
                                <form action="{{ route('admin.bill.save.rate') }}" method="post">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="site-input-groups">
                                                    <div class="input-group joint-input">
                                                        ...
                                                        <input type="number" name="rate[{{ $c }}]"
                                                            class="form-control" min="1"
                                                            value="{{ isset($rates[$c]) ? $rates[$c] : '' }}" />
                                    ...
                                    <button class="site-btn-sm primary-btn" type="submit"><i data-lucide="check"></i>
                                        {{ __('Save') }}</button>
                                </form>
                            </div>
                        </div>
